...
import { HeaderBar, LoadingScreen, MetricCard } from "../shared";
...
const FALLBACK_ANNOUNCEMENTS: Announcement[] = [
  {
    id: "1",
    title: "School Closed on 10 May for Elections",
    date: "3 May 2026",
  },
              ...
              <View style={styles.heatmapCard}>
                ...
                <View style={styles.heatmapHeaderRow}>
                  ...
                  {DAYS.map((d) => (
                    <View
                      key={d}
                      style={[styles.heatmapHeaderCell, { width: CELL_W }]}
                    >
        ...
        ListFooterComponent={
          <View style={styles.pendingCard}>
            <Text style={styles.pendingText}>
              3 exam results awaiting your approval
            </Text>
            <Pressable
