...
const EXAMS = Object.keys(EXAM_SCORES);
...
const STUDENTS: Student[] = [
  { rank: 1, name: 'Ananya Singh',  total: '363/400', pct: '91%', breakdown: { Math: 91, Science: 88, English: 95, Hindi: 89 } },
  { rank: 2, name: 'Aarav Sharma',  total: '351/400', pct: '88%', breakdown: { Math: 87, Science: 85, English: 91, Hindi: 88 } },
  { rank: 3, name: 'Kavya Nair',    total: '340/400', pct: '85%', breakdown: { Math: 84, Science: 83, English: 88, Hindi: 85 } },
  { rank: 4, name: 'Ishaan Verma',  total: '318/400', pct: '80%', breakdown: { Math: 78, Science: 80, English: 82, Hindi: 78 } },
  { rank: 5, name: 'Priya Reddy',   total: '302/400', pct: '76%', breakdown: { Math: 74, Science: 75, English: 79, Hindi: 74 } },
];
